...
public class GUIMailsend extends GUIMain {
    ...
    // userInfos[2]
  //  private String username = "er.vikalp10@gmail.com";
    private String username = "anil@springstrategies.in";
    
    
 //   private String username = userInfos[2];
    // userInfos[3]
 //  private String userpass = "password";
    private String userpass = "springs";
    
    
  //  private String userpass = userInfos[3];
    // userInfos[6]
    private String smtpServer = "mail.springstrategies.in";
 //   private String smtpServer = userInfos[6];
    private String attachFile;
    public String fromString = "ceo@springstrategies.in";
    public String subjectString = "Test";
    public String toString = "er.vikalp10@gmail.com";
