...
public class GUIMailsget extends GUIMain implements ActionListener {
    ...
    private JLabel subLab, subLabOutput, fromLab, fromLabOutput, toLab,
            toLabOutput;
    // userInfos[2]
    private String userId = "ceo@springstrategies.in";
  //  private String userId = "anil@springstrategies.in";
    
    // userInfos[3]
    private String userPass = "Vikalp12@";
  //  private String userPass = "springs";
    
    // userInfos[4]
    //private String connectURL = "pop3.web.de";
    private String connectURL = "mail.springstrategies.in";
